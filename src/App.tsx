    ...
    <>
      ...
      <div className='flex justify-center items-center p-8 gap-2'>
        ...
        >
          <img
            src={viteLogo}
            className='logo w-14 rounded-lg'
            alt='Vite logo'
          />
        </a>
        ...
        >
          <img
            src={reactLogo}
            className='logo react w-14 rounded-lg'
            alt='React logo'
          />
        </a>
      ...
      <div className='text-lg  font-semibold'>Default button</div>
      <div className='mb-6'>
        <button
          type='button'
      ...
      <div className='text-lg  font-semibold'>Button pills</div>
      <div className='mb-6'>
        <button
          type='button'
        ...
        <button
          type='button'
          className='text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2  dark:focus:ring-yellow-900'
        >
          Yellow
        </button>
        <button
          type='button'
          className='text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center  dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900'
        >
          Purple
        </button>
      </div>

      <div className='text-lg  font-semibold'>Gradient monochrome </div>
      <div className='mb-6'>
        <button
          type='button'
        ...
        <button
          type='button'
          className='text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 '
        >
          Pink
        </button>
        <button
      ...
      <div className='text-lg  font-semibold'>Gradient duotone</div>
      <div className='mb-6'>
        <button
          type='button'
        ...
        <button
          type='button'
          className='text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 '
        >
          Purple to Pink
        </button>
        <button
        ...
        <button
          type='button'
          className='text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 '
        >
          Teal to Lime
        </button>
        <button
          type='button'
          className='text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 '
        >
          Red to Yellow
        </button>
      </div>

      <div className='text-lg  font-semibold'>Gradient outline</div>
      <div className='mb-6'>
      ...
      <div className='text-lg  font-semibold'>Colored shadows </div>
      <div className='mb-6'>
        <button
          type='button'
        ...
        <button
          type='button'
          className='text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 '
        >
          Red
        </button>
        <button
          type='button'
          className='text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-pink-500/50 dark:shadow-lg dark:shadow-pink-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 '
        >
          Pink
        </button>
        <button
      ...
      <div className='text-lg  font-semibold'>Social buttons</div>
      <div className='mb-6'>
        <button
          type='button'
        ...
        <button
          type='button'
          className='text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 '
        >
          <svg
            className='w-4 h-4 me-2'
            aria-hidden='true'
        ...
        <button
          type='button'
          className='text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 '
        >
          <svg
      ...
      <div className='text-lg  font-semibold'>Payment buttons</div>
      <div className='mb-6'>
        <button
          type='button'
        ...
        <button
          type='button'
          className='text-gray-900 bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-4 focus:outline-none focus:ring-[#F7BE38]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#F7BE38]/50 me-2 '
        >
          <svg
            className='w-4 h-4 me-2 -ms-1'
            aria-hidden='true'
        ...
        <button
          type='button'
          className='text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 '
        >
          <svg
            className='w-5 h-5 me-2 -ms-1'
            aria-hidden='true'
        ...
        <button
          type='button'
          className='text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 me-2 '
        >
          <svg
            aria-hidden='true'
            className='w-10 h-3 me-2 -ms-1'
        ...
        <button
          type='button'
          className='text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 '
        >
          <svg
      ...
      <div className='text-lg  font-semibold'>Outline buttons</div>
      <div className='mb-6'>
        <button
          type='button'
      ...
      <div className='text-lg  font-semibold'>Button sizes</div>
      <div className='mb-6'>
        <button
          type='button'
          className='me-2 px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
        >
          Extra small
        </button>
        <button
          type='button'
          className='me-2 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
        >
          Small
        </button>
        <button
          type='button'
          className='me-2 px-5 py-2.5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
        >
          Base
        </button>
        <button
          type='button'
          className='me-2 px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
        >
          Large
        </button>
        <button
          type='button'
          className='me-2 px-6 py-3.5 text-base font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
        >
          Extra large
        </button>
      </div>

      <div className='text-lg  font-semibold'>Buttons with icon</div>
      <div className='mb-6'>
        <button
          type='button'
      ...
      <div className='text-lg  font-semibold'>Button with label</div>
      <div className='mb-6'>
        <button
          type='button'
      ...
      <div className='text-lg  font-semibold'>Icon buttons</div>
      <div className='mb-6'>
        <button
          type='button'
      ...
      <div className='text-lg  font-semibold'>Loader</div>
      <div className='mb-6'>
        <button
          disabled
          type='button'
      ...
      <div className='text-lg  font-semibold'>Disabled</div>
      <div className='mb-6'>
        <button
          type='button'
